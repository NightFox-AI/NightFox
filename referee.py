...
def referee(move, playerObj, gameTree):
	 playerObj1.du=dual(move,1,2)
	 playerObj2.du=dual(move,2,1)
	 playerObj1.fr=four(move,1,2)
	 playerObj2.fr=four(move,2,1)
	 playerObj1.th=three(move,1,2)
	 playerObj2.th=three(move,2,1)
	 payerObj1.tw=two(move)
	 playerObj1.ftb=failtoblock(move,1,2)
	 payerObj2.tw=two(move)
	 playerObj2.ftb=failtoblock(move,2,1)

	 fitness=0
	 fitness=pow(5,playerObj1.ftb)+pow(-5,playerObj2.ftb)+pow(2,playerObj1.th)+pow(3,playerObj1.tw)
	# playerObj2.fitness=pow(5,playerObj2.ftb)+pow(-5,playerObj1.ftb)+pow(2,playerObj2.th)+pow(3,playerObj2.tw)
	 return fitness

def failtoblock(move,e,f):
	count=0
